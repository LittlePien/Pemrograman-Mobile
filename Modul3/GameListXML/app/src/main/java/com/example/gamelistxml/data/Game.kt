...
val gameSample = listOf(
    Game(1, R.string.CO33Name, R.string.CO33Desc, R.string.CO33DescId, R.string.CO33Review, R.string.CO33Rate, R.drawable.cover_co33, R.drawable.detailcover_co33, "https://store.steampowered.com/app/1903340/Clair_Obscur_Expedition_33/"),
